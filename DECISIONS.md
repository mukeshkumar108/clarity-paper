...
10. **Papers are the authority, not the AI.** Synthesis text is a navigation aid — it helps users orient themselves in the evidence. It is not a verdict. The search surface opens with a short conversational reply and curated pathway cards, and follow-ups deepen the investigation naturally.

10a. **Search is a conversation, not a one-shot report.** The first response is 2-3 short paragraphs — an honest, direct answer, not a 5-section editorial review. Pathway cards are the primary interaction model for drilling deeper. Follow-up chips are secondary. The product should feel like talking to a smart friend who reads research, not like reading a briefing document.

10b. **Pathways are the main way to explore.** Each response generates 3-5 curated pathway cards with labels, previews, questions, evidence-fit ratings, and icons. Pathways feel like natural curiosity directions, not database headers. At least one pathway must be based on direct evidence. Users click a pathway to trigger a focused follow-up.

10b. **Sidebar conversation is operational, not performative.** Search follow-ups should feel like natural conversation, not rigid action routing. The orchestrator classifies intent to decide whether to answer from current evidence, expand the search, or ask a clarifying question — but the result should feel like a natural continuation of the investigation. Pathways make this feel like exploring with a guide, not filing a query form.
