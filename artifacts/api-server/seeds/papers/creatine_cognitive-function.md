...
```
```
Background: This study aimed to evaluate the effects of creatine monohydratea
...
(SMD = −0.51, 95% CI: −1.01 to −0.01, Hedges’s g  = −0.4916, 95% CI: −0.
...
I^2 value was less than 50%, a fixed-effect model was used ( 22 ); if the p
value was greater than or equal to 0.1 or the I^2 value was greater than
...
a heterogeneity (I^2 ) of 75% and a Z-value for the overall effect test of
...
of 0.32 (95% CI: −0.08 to 0.71), with a heterogeneity (I^2 ) of 0%
...
function time. The combined analysis shows an overall SMD of −0.
(95% CI: −0.47 to 0.41), with a heterogeneity (I^2 ) of 0% and a Z-value
...
The combined analysis shows an overall SMD of 0.22 (95% CI: −0.
to 0.84), with a heterogeneity (I^2 ) of 61% and a Z-value for the overall
...
−0.03), with a heterogeneity (I^2 ) of 18% and a Z-value for the overall
...
```
```
Delay recall (naming; incidental memory; immediate; learning; and delay recall)
```
```
Trail making test (part A; part B)
```
```
Stroop test (color condition; non-color condition; color word condition)
```
```
Digit span test (forward order; backward order)
```
```
Alves, Santiago, et al.
```
```
13/
```
...
```
```
Delay recall (naming; incidental memory; immediate; learning; delay recall)
```
```
...
```
```
Word memory test; Forward memory digit span test
```
```
Levental et al.
```
...
```
```
MSIB Global cognitive score
```
```
MSIB memory score
```
```
MSIB executive function score
```
```
MSIB visual spatial score
```
```
Li et al.
```
...
```
```
McMorris, Jonathan P Swain, et al.
```
```
10/
```
...
```
```
Forward verbal recall; Backward verbal recall; Forward spatial recall; Backward spatial recall backward
```
```
McMorris, R.C. Harris, et al.
```
```
10/
```
...
```
```
McMorriset, Gregorsz Mielcarz, et al.
```
```
15/
```
...
```
```
Forward number recall; Backward number recall; Forward spatial recall; Backward spatial recall; and Long-Term memory
```
...
```
```
CBT; RCBT; DTT; and VFDS
```
```
EFT (% correct answers same direction; % correct answers opposite directions) EFT (Arrows in same direction; Arrows in opposite direction)
```
```
VRT; GNGVRT; ART; GNGART
```
```
Rawson et al.
```
...
function. Twenty-four studies, encompassing a total of 1,
participants, assessed the potential effects of creatine
supplementation on memory function. The combined analysis

```
shows an overall SMD of 0.31 (95% CI: 0.18–0.44), with a
heterogeneity (I^2 ) of 21% and a Z-value for the overall effect test of
...
with a heterogeneity (I^2 ) of 0% and a Z-value for the overall effect
...
of −0.51 (95% CI: −1.01 to −0.01), with a heterogeneity (I^2 ) of 63%
...
studies was −0.31 (95% CI: −0.61 to 0), with heterogeneity (I^2 ) of
13.80%. In healthy individuals, five studies showed an SMD of −0.
(95% CI: −0.62 to 0.27), with I^2 of 38% and p value of 0.44, indicating
...
−0.96 to −0.08), I^2 of 0%, and p value of 0.02.
```
```
FIGURE 
...
was −0.31 (95% CI: −0.61 to 0), with I^2 of 81% and p value of 0.02.
In participants over 60 years old, three studies showed an SMD of

```
0.12 (95% CI: −0.34 to 0.58), with I^2 of 0% and p value of 0.61,
...
of −0.55 (95% CI: −0.90 to −0.21), with I^2 of 0% and p value
of 0.002.
Lastly, when analyzed by intervention duration, the overall SMD
from eight studies was −0.31 (95% CI: −0.61 to 0), with I^2 of 21% and
p value of 0.26. For interventions lasting less than 4 weeks, two studies
reported an SMD of −0.62 (95% CI: −1.25 to 0.01), with I^2 of 21% and
...
0.13), with I^2 of 14% and p value of 0.23, also indicating no
significant effect.
...
−0.51 (95% CI: −1.01 to −0.01), with heterogeneity (I^2 ) of 69% and a
p value of 0.04. In male participants, three studies showed an SMD of
−0.35 (95% CI: −0.99 to 0.30), with I^2 of 34% and a p value of 0.29,
...
CI: −1.53 to −0.21), with I^2 of 60% and a p-value of 0.01.
Overall, these findings suggest that creatine supplementation
...
I^2  = 23%; p < 0.00001). This result aligns with the study by Rawson
...
95% CI: −1.01 to −0.02; I^2 = 63%; p = 0.04) suggests that creatine
...
Global cognitive function Slope 0.6156409 0.7533144 0.82 0.46 −1.475895 to 2.
Bias −0.7782632 2.496782 −0.31 0.771 −7.710442 to 6.
Memory Slope 0.0695127 0.3543886 0.20 0.846 −0.6532676 to 0.
Bias 0.652748 0.9347061 0.70 0.490 −1.253598 to 2.
Executive function Slope 0.5291055 0.2851093 1.86 0.205 −0.6976209 to 1.
Bias −0.5121732 0.7099642 −0.72 0.546 −3.566903 to 2.
Executive function time Slope 8.736751 2.064796 4.23 0.148 −17.49897 to 34.
Bias −22.62588 5.325404 −4.25 0.147 −90.29155 to 45.
Attention Slope −0.0368459 8.946358 0 0.997 −38.52992 to 38.
Bias 0.6623473 22.68819 0.03 0.979 −96.95707 to 98.
Attention time Slope −0.0988147 6.466409 −0.02 0.988 −0.15.92155 to 15.
Bias −0.5551808 16.27624 −0.03 0.974 −40.38171 to 39.
Processing speed Slope 0.4612439 0.6309956 0.73 0.541 −2.253711 to 3.
Bias −1.14873 1.580664 −0.73 0.543 −7.949778 to 5.
Processing speed time Slope 2.875177 3.325391 0.86 0.420 −5.261762 to 11.
Bias −7.768328 7.624275 −1.02 0.348 −26.42426 to 10.
```
...
Nutrients. (2021) 13:1238. doi: 10.3390/nu
...
Physiol. (2001) 26:S79–S102. doi: 10.1139/h2001-
...
J Sport Sci. (2019) 19:1–14. doi: 10.1080/17461391.2018.
...
Biochimie. (2015) 119:146–65. doi: 10.1016/j.biochi.2015.10.
...
building the case. Adv Nutr. (2021) 13:34–7. doi: 10.1093/advances/nmab
11. Gauthier S, Reisberg B, Zaudig M, Petersen RC, Ritchie K, Broich K, et al. Mild
cognitive impairment. Lancet. (2006) 367:1262–70. doi: 10.1016/S0140-6736(06)68542-
...
BMJ. (2021) 37:1322–31. doi: 10.1136/bmj.n
...
meta-analyses. BMJ. (2003) 327:557–60. doi: 10.1136/bmj.327.7414.
23. DerSimonian R, Laird N. Meta-analysis in clinical trials. Control Clin Trials. (1986)
7:177–88. doi: 10.1016/0197-2456(86)90046-
...
PLoS One. (2013a) 8:e76301. doi: 10.1371/journal.pone.
...
controlled trial. Arthritis Care Res. (2013b) 65:1449–59. doi: 10.1002/acr.
...
(2020) 60:1168–70. doi: 10.23736/S0022-4707.20.10589-
...
disease. Eur Neurol. (2015) 73:205–11. doi: 10.1159/
...
Brain Sci. (2023) 13:9. doi: 10.3390/brainsci
...
Environ Res Public Health. (2022) 19:7992. doi: 10.3390/ijerph
...
study. BMC Med. (2023) 21:440. doi: 10.1186/s12916-023-03146-
...
35:1773–80. doi: 10.1523/JNEUROSCI.3113-14.
...
17:822–31. doi: 10.1519/1533-4287(2003)017<0822:eocsar>2.0.co;
35. Elechi JOG, Guandique DMA, Cannataro R. Creatine in cognitive performance:
a commentary. Curr Mol Pharmacol. (2024) 17:e18761429272915. doi: 10.
4/
...
12:RP89317. doi: 10.7554/eLife.89317.
...
adults. Nutr Health. (2023) 29:731–6. doi: 10.1177/
...
cross-over trial. Proc Biol Sci. (2003) 270:2147–50. doi: 10.1098/rspb.2003.
...
Med Sci Sports Exerc. (2020) 52:120–30. doi: 10.1249/MSS.
002122
